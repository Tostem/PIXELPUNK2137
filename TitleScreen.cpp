...
void TitleScreen::Draw(sf::RenderWindow& okno_gry)
{
...
void TitleScreen::select(int x, int y, bool& k, bool& m, float deltaTime, sf::Texture* resume_button, sf::Texture* exit_button, sf::Texture* hand)
{
